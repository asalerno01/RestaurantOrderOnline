    ...
    public partial class newfix : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accounts_RefreshTokens", x => new { x.AccountId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users_RefreshTokens", x => new { x.ApplicationUserId, x.Id });
                    table.ForeignKey(
                        name: "FK_Users_RefreshTokens_Users_ApplicationUserId",
